<!-- resources/views/private/products/create.blade.php -->
...
<head>
    ...
    <title>Create Product - Halcon</title>
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <p class="page-subtitle">Add a new product to the system</p>
        </div>

        <div class="form-card">
            <form action="{{ route('private.products.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-input form-textarea">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="error-message">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="price" name="price" class="form-input" step="0.01" value="{{ old('price') }}" required>
                    @error('price')
                        <p class="error-message">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="stock" name="stock" class="form-input" value="{{ old('stock') }}" required>
                    @error('stock')
                        <p class="error-message">{{ $message }}</p>
                    @enderror
                </div>
